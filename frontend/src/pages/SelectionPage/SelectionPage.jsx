...
const IconPaciente = () => (<svg width="24" height="24" viewBox="0 0 24 24" style={{ color: "var(--text-primary)" }}><path fill="currentColor" d="M12 2a5 5 0 1 1 0 10 5 5 0 0 1 0-10Zm0 12c4.418 0 8 2 8 4.5V21H4v-2.5C4 16 7.582 14 12 14Z"/></svg>);
...
const styles = { question: { fontWeight: 800, marginBottom: "28px", fontSize: "22px", color: "var(--text-primary)" }, buttons: { display: "flex", flexDirection: "column", gap: "24px", maxWidth: "500px" }, glassTitle: { fontWeight: 900, color: "var(--text-primary)", fontSize: "16px" }, glassSub: { fontSize: "14px", color: "var(--text-secondary)", marginTop: "3px" } };
